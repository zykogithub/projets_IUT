...
public abstract class Proposition implements Iproposition {
    ...
    public int getIdThematique() {return id_thematique;}
    ...
    public String toString() {
        return titre + "\n          " + budget + "€ ; idTheme : "+id_thematique+" ; choix '"+choixGagnant()+"' gagnant, avec "+nbSatisfaits()+" votes";
    }
    ...
    /**
     * Retourne l'id du choix gagnant (celui avec le plus de votes).
