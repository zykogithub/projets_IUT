...
public class VueParametresGroupe extends JPanel {
    ...
    public VueParametresGroupe(Groupe groupe) {
        ...
        panel.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20)); // Padding autour du panel principal
        panel.setBackground(new Color(240, 240, 240)); // Couleur de fond légèrement grise
        ...
        for (Thematique thematique : this.groupe.getThematiques()) {
            ...
            panelThematique.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20)); // Padding autour du panel principal
            panelThematique.setBackground(new Color(240, 240, 240)); // Couleur de fond légèrement grise
            panelThematique.setLayout(new BoxLayout(panelThematique, BoxLayout.Y_AXIS));
            
            panelThematique.add(texteMensuel);
            panelThematique.add(Box.createVerticalStrut(10)); // Ajout d'un espace blanc vertical
